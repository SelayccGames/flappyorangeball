...
public class SoundController : Singleton<SoundController>
{
    ...
    [Space(10)]
    [Range(0, 1)] [SerializeField] float _musicVolume = 0.5f;
    ...
    [SerializeField] AudioClip _normalScore;
    [SerializeField] AudioClip _swishScore;
    ...
    private AudioClip GetClip(AudioType audioType)
    {
        switch (audioType)
        {
            case AudioType.JUMP:
                return _jump;
            case AudioType.NORMALSCORE:
                return _normalScore;
            case AudioType.SWISHSCORE:
                return _swishScore;
